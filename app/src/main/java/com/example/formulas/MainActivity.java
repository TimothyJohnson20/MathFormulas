...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        //  based on what they click, you constrict the right fragment type
        if (id == R.id.nav_pythag) {
            // If they clicked on the pythagorean menu, load the com.example.formulas.PythagoreanFragment
